    ...
    sections: List[Tuple[str, Iterator[Dict[str, Any]]]] = [
        ...
        ("scheduled_runs", _rows(stream_db, ScheduledRun,
                                 ...
                                 serialize=lambda r: {"workflow": r.workflow, "state": r.state,
                                                       ...
                                                       "reason": r.reason})),
        ("automation_policies", _rows(stream_db, AutomationPolicy,
                                      (AutomationPolicy.scope, AutomationPolicy.scope_key,
                                       AutomationPolicy.workflow, AutomationPolicy.enabled,
                                       AutomationPolicy.mode, AutomationPolicy.mode_chosen_at,
                                       AutomationPolicy.version, AutomationPolicy.created_at,
                                       AutomationPolicy.updated_at), uid,
                                      serialize=lambda r: {"scope": r.scope, "scope_key": r.scope_key,
                                                           "workflow": r.workflow, "enabled": r.enabled,
                                                           "mode": r.mode,
                                                           "mode_chosen_at": _iso(r.mode_chosen_at),
                                                           "version": r.version,
                                                           "created_at": _iso(r.created_at),
                                                           "updated_at": _iso(r.updated_at)})),
        ("automation_policy_revisions", _rows(stream_db, AutomationPolicyRevision,
                                              (AutomationPolicyRevision.policy_id,
                                               AutomationPolicyRevision.version,
                                               AutomationPolicyRevision.document,
                                               AutomationPolicyRevision.changed_keys,
                                               AutomationPolicyRevision.actor_type,
                                               AutomationPolicyRevision.actor_id,
                                               AutomationPolicyRevision.reason,
                                               AutomationPolicyRevision.created_at), uid,
                                              serialize=lambda r: {"policy_id": r.policy_id,
                                                                   "version": r.version,
                                                                   "document": r.document,
                                                                   ...
                                                                   "reason": r.reason,
                                                                   "created_at": _iso(r.created_at)})),
        ("automation_submission_counters", _rows(stream_db, AutomationSubmissionCounter,
                                                 (AutomationSubmissionCounter.workflow,
                                                  AutomationSubmissionCounter.period,
                                                  AutomationSubmissionCounter.record,
                                                  AutomationSubmissionCounter.rejected), uid,
                                                 serialize=lambda r: {"workflow": r.workflow,
                                                                      "period": r.period,
                                                                      "record": r.record,
                                                                      "rejected": r.rejected})),
